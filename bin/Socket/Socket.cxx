...
Socket Socket::accept(std::auto_ptr<SockAddr::SockAddr> *client_address) throw(Errno) {
	...
	if( client_address != NULL ) {
		*client_address = SockAddr::create(reinterpret_cast<struct sockaddr *>(&a));
	}
	return s;
}
...
std::auto_ptr<SockAddr::SockAddr> Socket::getsockname() const throw(Errno) {
	...
	std::auto_ptr<SockAddr::SockAddr> addr( SockAddr::create(reinterpret_cast<struct sockaddr*>(&a)) );
	return addr;
}
